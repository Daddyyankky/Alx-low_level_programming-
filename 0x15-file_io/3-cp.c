...
/**
 * main - Copy contents of the file to another file.
 * @argc: num of arguments supply to the program.
 * @argv: array of pointer to arguments.
 *
 * Return: 0 success.
 *
 * Description: if argument count not correct - exit code 97.
 * If file_from doesn't exist or can't be read - exit code 98.
 * If file_to can not create or written to - exit code 99.
 * If file_to or file_fron can't be closed - exit code 100.
 */
