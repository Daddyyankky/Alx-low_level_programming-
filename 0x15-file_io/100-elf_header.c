 ...
 * @n: the max num of bytes to compare
 *
...
/**
 * _close - the close  file descriptor and print an error message upon failure
...
/**
 * _read - read from  file and print  error message upon failure
 * @fd:  file descriptor to read from
 * @buf: the buffer to write to
 * @count: the num of bytes to read
 */
...
/**
 * elf_class - print a ELF class
 * @buffer:  ELF header
 *
 * Return:a bit mode (32 or 64)
 */
...
/**
 * elf_version - a print ELF version
 * @buffer: the ELF header
 */
...
/**
 * elf_abivers - print the ELF ABI version
 * @buffer: ELF header
 */
...
/**
 * elf_entry - print an entry point address
 * @buffer: a string containing the entry point address
